    ...
    while(max_depth!=-1):
        while tocrawl:
            ...
            if page not in crawled:
                ...
                x+=1
        while x>=1:
            union(tocrawl, get_all_links(get_page(crawled[-x])))
            x-=1
        max_depth-=1
        x=0
    return crawled
...
##        for page in tocrawl + []: # ==> create a new list object, identical to 'tocrawl'
##            if page not in crawled:
...
print crawl_web("http://top.contributors/velak.html",3)
...
#print crawl_web("http://top.contributors/forbiddenvoid.html",3)
